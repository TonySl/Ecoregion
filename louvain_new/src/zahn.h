...
class Zahn: public Quality {
 public:
  ...
  inline long double gain(int node, int comm, long double dnodecomm, long double w_degree, long double reso2);  //Tony, this reso2 was useless, just to keep the format of quality clsss
...
inline long double
Zahn::gain(int node, int comm, long double dnc, long double degc,long double reso2) {  //Tony
  assert(node>=0 && node<size);
