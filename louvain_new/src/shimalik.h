...
class ShiMalik: public Quality {
 public:
  ...
  inline long double gain(int node, int comm, long double dnodecomm, long double w_degree, long double reso2);
...
inline long double
ShiMalik::gain(int node, int comm, long double dnc, long double degc, long double reso2) {
  assert(node>=0 && node<size);
