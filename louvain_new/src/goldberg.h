...
class Goldberg: public Quality {
 public:
  ...
  inline long double gain(int node, int comm, long double dnodecomm, long double w_degree, long double reso2); //Tony
...
inline long double
Goldberg::gain(int node, int comm, long double dnc, long double degc,long double reso2) { //Tony
  assert(node>=0 && node<size);
